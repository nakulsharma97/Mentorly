...
import com.mentorly.verification.MentorVerificationRequest;
...
class AdminControllerIntegrationTest {
    ...
    @MockitoBean
    private com.mentorly.common.AuditLogService auditLogService;
    @MockitoBean
    ...
    @MockitoBean
    private com.mentorly.moderation.FlaggedContentRepository flaggedContentRepository;

    @MockitoBean
    private com.mentorly.skill.SkillRepository skillRepository;

    @MockitoBean
    private com.mentorly.notification.AppNotificationRepository appNotificationRepository;

    @MockitoBean
    private com.mentorly.monitoring.SystemHealthService systemHealthService;
    ...
    @MockitoBean
    private com.mentorly.user.UserProjectService userProjectService;
    ...
    void health_returnsOk_forAdmin() throws Exception {
        ...
        com.mentorly.monitoring.MonitoringDtos.AdminHealthDto dto =
                new com.mentorly.monitoring.MonitoringDtos.AdminHealthDto(
    ...
    void healthLogs_returnsLogs_forAdmin() throws Exception {
        ...
        when(systemHealthService.recentLogs(eq("ERROR"), eq("login"), anyInt()))
                .thenReturn(List.of(new com.mentorly.monitoring.LogBufferService.LogEntry(
    ...
    void createBroadcast_returnsOk() throws Exception {
        ...
        com.mentorly.notification.NotificationBroadcast b = new com.mentorly.notification.NotificationBroadcast();
        b.setId(9L);
