...
-- username_lower (NOT NULL/UNIQUE since V56) mirrors the lowercase username
-- so the case-insensitive uniqueness constraint is satisfied on insert.
INSERT IGNORE INTO users (email, username, username_lower, password_hash, role, full_name, enabled, referral_code, created_at)
VALUES
  ('mentor@test.com', 'mentor', 'mentor', '$2b$12$eqUeoZHM2YjitmaQTeKEke7lbyb77rh3wGQa0FxrohXxZN.QuZ9tS', 'MENTOR', 'Test Mentor', TRUE, 'MENTOR01', CURRENT_TIMESTAMP),
  ('learner@test.com', 'learner', 'learner', '$2b$12$eqUeoZHM2YjitmaQTeKEke7lbyb77rh3wGQa0FxrohXxZN.QuZ9tS', 'LEARNER', 'Test Learner', TRUE, 'LEARNER01', CURRENT_TIMESTAMP);
