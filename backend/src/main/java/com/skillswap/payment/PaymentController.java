...
public class PaymentController {
        ...
        @Transactional
        public ApiResponse<Payment> updateStatus(@AuthenticationPrincipal User currentUser, @PathVariable Long id,
                        @RequestHeader("Idempotency-Key") String idempotencyKey,
        ...
        public record PaymentIntentRequest(Long bookingId, BigDecimal amount, String mode) {
        }
