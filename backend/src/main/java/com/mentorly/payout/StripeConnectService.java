    ...
    public void handleTransferFailed(Map<String, Object> eventData) {
        ...
        ledgerRepository.findAll().stream()
                ...
                .ifPresent(entry -> {
                    ...
                    com.mentorly.wallet.WalletService.WalletEntryRequest reversal =
                            new com.mentorly.wallet.WalletService.WalletEntryRequest(
                    ...
                    com.mentorly.wallet.WalletLedgerEntry credit = new com.mentorly.wallet.WalletLedgerEntry();
                    ...
                    BigDecimal currentBalance = ledgerRepository
                            ...
                            .map(com.mentorly.wallet.WalletLedgerEntry::getBalanceAfter)
