...
import com.mentorly.safety.ReportStatus;
import com.mentorly.safety.UserReport;
...
import com.mentorly.verification.MentorVerificationDto;
import com.mentorly.verification.MentorVerificationRequestRepository;
import com.mentorly.verification.MentorVerificationRequestStatus;
import com.mentorly.moderation.FlaggedContent;
import com.mentorly.moderation.FlaggedContentRepository;
import com.mentorly.skill.SkillRepository;
import com.mentorly.notification.AppNotificationRepository;
...
import com.mentorly.booking.CompletionReviewStatus;
import com.mentorly.booking.ConfirmationStatus;
import com.mentorly.chat.ChatMessage;
import com.mentorly.chat.ChatMessageRepository;
import com.mentorly.messaging.DirectConversation;
import com.mentorly.messaging.DirectConversationRepository;
import com.mentorly.messaging.DirectMessage;
import com.mentorly.messaging.DirectMessageRepository;
...
import com.mentorly.notification.NotificationBroadcast;
...
import com.mentorly.monitoring.LogBufferService;
import com.mentorly.monitoring.MonitoringDtos;
import com.mentorly.monitoring.SystemHealthService;
...
public class AdminController {
    ...
    private final com.mentorly.config.MaintenanceModeFilter maintenanceModeFilter;
    @org.springframework.beans.factory.annotation.Autowired(required = false)
    @org.springframework.context.annotation.Lazy
    private com.mentorly.booking.BookingLifecycleService bookingLifecycleService;
    ...
    public ApiResponse<CompletionEvidenceDto> getCompletionEvidence(
        ...
        List<com.mentorly.chat.ChatMessage> chatMessages = chatMessageRepository
        ...
        java.util.Collection<com.mentorly.booking.CompletionReviewStatus> disputeStatuses =
                java.util.List.of(
                        com.mentorly.booking.CompletionReviewStatus.DISPUTED,
                        com.mentorly.booking.CompletionReviewStatus.REVIEW_REQUIRED);
    ...
    /**
     * Clears ALL Spring Cache entries (including Redis when enabled).
     * Use when data has been updated externally or after a deployment.
     */
    @PostMapping("/settings/clear-all-caches")
    public ApiResponse<Map<String, String>> clearAllCaches(
            @AuthenticationPrincipal User currentUser,
        ...
        maintenanceModeFilter.invalidateCache();
        saveAuditLog(currentUser, "CLEAR_ALL_CACHES", "Settings", null,
                "Cleared all Spring Cache entries (including Redis)");
        return new ApiResponse<>("All caches cleared", Map.of("status", "cleared"));
    }
