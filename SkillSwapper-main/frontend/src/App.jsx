...
export default function App() {
  ...
  const needsProfileSetup = isLoggedIn && profileChecked && profile?.role !== 'ADMIN' && !isProfileComplete(profile);
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn) {
      ...
      if (pathname !== '/oauth/callback' && !publicPaths.includes(pathname) && !isPublicMentorProfile) {
        navigate('/home', { replace: true });
      }
      return;
    }
  ...
  const openProfile = () => navigate('/profile-setup');
  ...
  return (
    <ThemeProvider>
      <div className="app-shell">
        ...
        {/* Global navbar restored */}
        <Navbar isLoggedIn={isLoggedIn} profile={profile} onOpenProfile={openProfile} onOpenNotifications={openNotifications} onLogout={handleLogout} authMode={authMode} onSelectAuthMode={handleSelectAuthMode} language={language} onLanguageChange={handleLanguageChange} unreadNotifications={unreadNotifications} />
