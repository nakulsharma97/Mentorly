  ...
  const loadReviews = async () => {
    ...
    try {
      ...
      notify?.({
        ...
        message: "We could not load your review data right now.",
      });
    } finally {
      setLoading(false);
    }
  ...
  const filteredReviews = useMemo(() => {
    ...
    return reviews.filter((review) => {
      ...
      const matchesSession =
        filters.session === "all" || review.sessionTitle === filters.session;
      const matchesVerified = !filters.verifiedOnly || review.learnerVerified;
      const matchesReply = !filters.pendingReply || !review.replyText;
      return (
        matchesSearch &&
        matchesRating &&
        matchesSkill &&
      ...
      <div className="md-shell md-animate">
        <header className="mp-head">
          ...
          <div className="mp-head__actions">
            ...
            <button className="md-btn md-btn--outline md-btn--sm" type="button">
              <Icon name="filter_alt" /> Filter
            </button>
            <button className="md-btn md-btn--brand md-btn--sm" type="button">
