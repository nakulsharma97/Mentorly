...
const ENDPOINTS = [
  ...
  { method: 'GET', path: '/api/v1/admin/dashboard?months=6', desc: 'Dashboard trends and health metrics (signups, revenue, sessions)', group: 'Overview' },
  ...
  { method: 'GET', path: '/api/v1/admin/reports?status=OPEN', desc: 'List user reports by status', group: 'Moderation' },
  ...
  { method: 'PATCH', path: '/api/v1/admin/flagged-content/{id}', desc: 'Moderate flagged content (resolve, dismiss)', group: 'Moderation' },
  { method: 'POST', path: '/api/v1/admin/notifications/broadcast', desc: 'Send platform-wide announcement', group: 'Notifications' },
